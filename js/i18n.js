...
const I18N = {
  zh: {
    ...
    'js.ev_eh': 'EV/EH',
    'js.ev_revenue': 'EV/营收',
    'js.ev_ebitda': 'EV/EBITDA',
    'js.pe_ratio': 'P/E',
    'js.efficiency': '效率 (J/TH)',
    'js.signal_conflict': '信号矛盾',
    'js.signal_conflict_tip': '方向与预期收益不一致',

    // Comp Table
    'comp.title': '同业对比表',
    'comp.subtitle': '关键估值与运营指标横向对比',
    'comp.ticker': '代码',
    'comp.market_cap': '市值 (M)',
    'comp.ev': 'EV (M)',
    'comp.revenue': '营收 (M)',
    'comp.ebitda': 'EBITDA (M)',
    'comp.pe': 'P/E',
    'comp.ev_revenue': 'EV/Rev',
    'comp.ev_ebitda': 'EV/EBITDA',
    'comp.ev_eh': 'EV/EH',
    'comp.hashrate': '算力 (EH/s)',
    'comp.efficiency': '效率 (J/TH)',
    'comp.na': '—',

    // Stats bar EV/EH
    'stats.avg_ev_eh': '行业平均 EV/EH',
    'stats.avg_ev_eh_sub': '企业价值/算力',

    // Analysis tab
    'nav.analysis': '财务分析',
    'analysis.title': '财务分析模型',
    'analysis.subtitle': '基于公开财务数据的量化分析',
    ...
    // Derivatives
    'mp.derivatives': '衍生品仪表盘',
    'mp.derivatives_sub': '资金费率 · 持仓量 · 多空比 · 买卖比',
    'mp.funding_rate': '资金费率',
    'mp.long_short': '多空比',
    'mp.taker_ratio': '主动买卖比',
    'mp.open_interest': '持仓量 (OI)',
    'mp.fr_history': '资金费率历史 (7天)',
    'mp.fr_desc': '永续合约每8小时结算一次。正值=多头付费给空头（市场偏多），负值=空头付费给多头（市场偏空）',
    'mp.oi_vs_price': '持仓量 vs 价格 (7天)',
    'mp.fr_neutral': '中性',
    'mp.fr_positive': '偏多头',
    'mp.fr_negative': '偏空头',
    'mp.fr_extreme_pos': '极端多头',
    'mp.fr_extreme_neg': '极端空头',
    'mp.oi_rising': '上升',
    'mp.oi_falling': '下降',
    'mp.oi_flat': '平稳',
    'mp.bias_long': '偏多',
    ...
    'analysis.grade_c': '一般',
    'analysis.grade_d': '警示',
    'analysis.subtitle_v2': '六大量化模型 + 卖方分析师估值方法',
    'analysis.tab_model': '方法预测',
    'analysis.tab_analyst': '分析师预测',
    'av.view_coverage': '覆盖矩阵',
    'av.view_methods': '方法分布',
    'av.view_drilldown': '个股下钻',
    'av.bank': '投行',
    'av.ticker': '矿企',
    'av.analyst': '分析师',
    'av.date': '日期',
    ...
    'av.target_price': '目标价',
    'av.method': '估值方法',
    'av.method_detail': '方法明细',
    'av.source': '来源',
    'av.banks': '投行数',
    'av.companies': '矿企数',
    'av.records': '记录数',
    'av.method_coverage': '方法覆盖率',
    'av.updated': '更新',
    'av.no_data': '暂无数据',
    'av.method_desc': '统计当前覆盖样本中各估值方法的使用占比。SOTP（分部加总）通常用于同时涉及挖矿与 HPC/AI 的混合业务公司。',
    'av.count': '记录数',
    'av.pct': '占比',
    'av.select_company': '选择矿企',
    'av.consensus_median': '目标价中位数',
    ...
    // ── v2.0424E media (Batch D feat-014) ──
    'media.range.24h': '24小时',
    'media.range.72h': '3天',
    'media.range.168h': '7天',
    'media.range.720h': '30天',
    'media.sort.latest': '最新动态',
    'media.sort.mentions': '声量',
    'media.filter.all': '全部',
    'media.filter.ticker': '公司',
    'media.filter.platform': '平台',
    'media.filter.sentiment': '情感',
    'media.filter.clear': '清除全部',
    'media.filter.prefix': '筛选：',
    'media.platform.all': '全部平台',
    'media.platform.news': '新闻',
    'media.platform.twitter': 'Twitter',
    'media.platform.reddit': 'Reddit',
    'media.platform.youtube': 'YouTube',
    'media.platform.blog': '博客',
    'media.platform.facebook': 'Facebook',
    'media.platform.instagram': 'Instagram',
    'media.sentiment.all': '全部情感',
    'media.sentiment.positive': '正面',
    'media.sentiment.neutral': '中性',
    'media.sentiment.negative': '负面',
    'media.sentiment.distribution': '情感分布',
    'media.chart.stacked': '堆叠柱',
    'media.chart.line': '折线',
    'media.chart.backToRange': '← 返回 30 天视图',
    'media.link.dead': '🔗 链接失效',
    'media.link.paywall': '🔒 访问受限',
    'media.reach.label': '触达',
    'media.reach.placeholder': 'Reach 分布 (即将推出)',
    'media.kol.title': 'KOL 影响力榜',
    'media.kol.positive': '正面支持 (可合作)',
    'media.kol.critical': '批评声音 (需关注)',
    'media.kol.author': '作者',
    'media.kol.platform': '平台',
    'media.kol.score': '得分',
    'media.kol.mentions': '讨论数',
    'media.kol.reach': '触达',
    'media.kol.empty': '暂无数据',
    'media.kol.loading': '加载中...',
    'media.alertBrief.title': '🚨 告警简报',
  ...
  en: {
    ...
    'js.ev': 'Enterprise Value',
    'js.ev_eh': 'EV/EH',
    'js.ev_revenue': 'EV/Revenue',
    'js.ev_ebitda': 'EV/EBITDA',
    'js.pe_ratio': 'P/E',
    'js.efficiency': 'Efficiency (J/TH)',
    'js.signal_conflict': 'Signal Conflict',
    'js.signal_conflict_tip': 'Direction conflicts with expected return',

    // Comp Table
    'comp.title': 'Comp Table',
    'comp.subtitle': 'Key valuation & operational metrics comparison',
    'comp.ticker': 'Ticker',
    'comp.market_cap': 'Mkt Cap (M)',
    'comp.ev': 'EV (M)',
    'comp.revenue': 'Revenue (M)',
    'comp.ebitda': 'EBITDA (M)',
    'comp.pe': 'P/E',
    'comp.ev_revenue': 'EV/Rev',
    'comp.ev_ebitda': 'EV/EBITDA',
    'comp.ev_eh': 'EV/EH',
    'comp.hashrate': 'Hashrate (EH/s)',
    'comp.efficiency': 'Efficiency (J/TH)',
    'comp.na': '--',

    // Stats bar EV/EH
    'stats.avg_ev_eh': 'Avg EV/EH',
    'stats.avg_ev_eh_sub': 'Enterprise Value / Hashrate',

    // Analysis tab
    'nav.analysis': 'Analysis',
    'analysis.title': 'Financial Analysis Models',
    'analysis.subtitle': 'Quantitative analysis based on public financial data',
    ...
    'analysis.subtitle_v2': 'Six quantitative models + sell-side analyst valuation methodologies',
    'analysis.tab_model': 'Method Forecast',
    'analysis.tab_analyst': 'Analyst Forecast',
    'av.view_coverage': 'Coverage Matrix',
    'av.view_methods': 'Method Distribution',
    'av.view_drilldown': 'Per-Ticker Drilldown',
    'av.bank': 'Bank',
    'av.ticker': 'Ticker',
    'av.analyst': 'Analyst',
    'av.date': 'Date',
    'av.rating': 'Rating',
    'av.target_price': 'Target Price',
    'av.method': 'Valuation Method',
    'av.method_detail': 'Method Detail',
    'av.source': 'Source',
    'av.banks': 'Banks',
    'av.companies': 'Companies',
    'av.records': 'Records',
    'av.method_coverage': 'Method Coverage',
    'av.updated': 'Updated',
    'av.no_data': 'No data yet',
    'av.method_desc': 'Distribution of valuation methodologies across covered analyst reports. SOTP (sum-of-the-parts) is typically used for hybrid companies operating both mining and HPC/AI segments.',
    'av.count': 'Records',
    'av.pct': 'Share',
    'av.select_company': 'Select company',
    'av.consensus_median': 'Median Target',
    ...
    'mp.poly_only': 'Polymarket',
    'mp.hist_pred': 'Historical Predictions',
    'mp.betting_consensus': 'Betting Consensus',
    ...
    // Derivatives
    'mp.derivatives': 'Derivatives Dashboard',
    'mp.derivatives_sub': 'Funding Rate · OI · Long/Short · Taker Ratio',
    'mp.funding_rate': 'Funding Rate',
    'mp.long_short': 'Long/Short Ratio',
    'mp.taker_ratio': 'Taker Buy/Sell',
    'mp.open_interest': 'Open Interest',
    'mp.fr_history': 'Funding Rate History (7d)',
    'mp.fr_desc': 'Perpetual swap settled every 8h. Positive = longs pay shorts (bullish bias), Negative = shorts pay longs (bearish bias)',
    'mp.oi_vs_price': 'OI vs Price (7d)',
    'mp.fr_neutral': 'Neutral',
    'mp.fr_positive': 'Positive',
    'mp.fr_negative': 'Negative',
    'mp.fr_extreme_pos': 'Extreme Positive',
    'mp.fr_extreme_neg': 'Extreme Negative',
    'mp.oi_rising': 'Rising',
    'mp.oi_falling': 'Falling',
    'mp.oi_flat': 'Flat',
    'mp.bias_long': 'Long Bias',
    'mp.bias_short': 'Short Bias',
    ...
    'media.range.72h': '3d',
    'media.range.168h': '7d',
    'media.range.720h': '30d',
    'media.sort.latest': 'Latest activity',
    'media.sort.mentions': 'Volume',
    'media.filter.all': 'All',
    'media.filter.ticker': 'Ticker',
    'media.filter.platform': 'Platform',
    'media.filter.sentiment': 'Sentiment',
    'media.filter.clear': 'Clear all',
    'media.filter.prefix': 'Filter:',
    'media.platform.all': 'All platforms',
    'media.platform.news': 'News',
    'media.platform.twitter': 'Twitter',
    'media.platform.reddit': 'Reddit',
    'media.platform.youtube': 'YouTube',
    'media.platform.blog': 'Blog',
    'media.platform.facebook': 'Facebook',
    'media.platform.instagram': 'Instagram',
    'media.sentiment.all': 'All sentiment',
    'media.sentiment.positive': 'Positive',
    'media.sentiment.neutral': 'Neutral',
    'media.sentiment.negative': 'Negative',
    'media.sentiment.distribution': 'Sentiment distribution',
    'media.chart.stacked': 'Stacked',
    'media.chart.line': 'Line',
    'media.chart.backToRange': '← Back to 30d view',
    'media.link.dead': '🔗 Dead link',
    'media.link.paywall': '🔒 Paywalled',
    'media.reach.label': 'Reach',
    'media.reach.placeholder': 'Reach distribution (coming soon)',
    'media.kol.title': 'KOL Influence Board',
    'media.kol.positive': 'Advocates (outreach candidates)',
    'media.kol.critical': 'Critics (monitor)',
    'media.kol.author': 'Author',
    'media.kol.platform': 'Platform',
    'media.kol.score': 'Score',
    'media.kol.mentions': 'Mentions',
    'media.kol.reach': 'Reach',
    'media.kol.empty': 'No data',
    'media.kol.loading': 'Loading...',
    'media.alertBrief.title': '🚨 Alert Brief',
